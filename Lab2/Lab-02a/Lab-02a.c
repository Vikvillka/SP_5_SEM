...
int main() {
    ...
    wchar_t path[256] = L"D:\\5_SEM_LABS\\SP\\Lab2\\x64\\Debug\\Lab-02x.exe";
    wchar_t buff[256] = L"";
    wcscpy(buff, path);
    wchar_t path2[256] = L"D:\\5_SEM_LABS\\SP\\Lab2\\x64\\Debug\\Lab-02x.exe 100";
    ...
    CreateChildProcess(path, wcscat(buff, L" 50"), si3, pi3);
