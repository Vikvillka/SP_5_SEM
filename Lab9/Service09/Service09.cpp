...
string LOG_DIR = "D:\\5_SEM_LABS\\SP\\Lab9\\x64\\Logs";
string WATCH_DIR = "D:\\5_SEM_LABS\\SP\\Lab9\\x64\\Debug";
        ...
        if (ReadDirectoryChangesW(
            ...
            do {
                ...
                case FILE_ACTION_RENAMED_OLD_NAME:
                    LogDirectoryEvent(string("Old name: ") + fileNameChar);
                    break;
                case FILE_ACTION_RENAMED_NEW_NAME:
                    LogDirectoryEvent(string("New name: ") + fileNameChar);
                    break;
                default:
